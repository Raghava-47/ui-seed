        ...
        window.App = $rootScope.App = {
            ...
            tabs: [
              //  {icon: 'fa-tachometer', state: 'dashboards', label: 'Dashboards'},
                {icon: 'fa-file-o', state: 'scorecard', label: 'Score Card'},{icon: 'fa-file-o', state: 'search', label: 'Search'},{icon: 'fa-file-o', state: 'update', label: 'Update'},{icon: 'fa-file-o', state: 'view', label: 'View'}
            ]
        };
